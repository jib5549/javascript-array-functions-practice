...
// const firstNames = characters.map(character => character.name.split(" ")[0]) // splitting it based on the space inside the object
...
const massHundredOver = characters.filter( character => {
    return character.mass > 100
})
console.log(massHundredOver);
